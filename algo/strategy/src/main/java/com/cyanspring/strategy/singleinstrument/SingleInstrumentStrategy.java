 ...
 *
 */
public abstract class SingleInstrumentStrategy extends Strategy {
	...
	public RemoteAsyncEvent createConfigUpdateEvent() throws StrategyException {
			return new SingleInstrumentStrategyFieldDefUpdateEvent(null, null, getStrategyName(), getCombinedFieldDefs());
	}
...
//	public Set<ChildOrder> getSortedOpenChildOrders() {
//		return OrderUtils.getSortedOpenChildOrders(childOrders.values());
//	}
//	
	...
	public void execute(ExecuteTiming timing) {
		...
		//QPE framework
		QuantityInstruction qi = quantityAnalyzer.analyze(this);
		PriceInstruction pi = priceAnalyzer.analyze(qi, this);
