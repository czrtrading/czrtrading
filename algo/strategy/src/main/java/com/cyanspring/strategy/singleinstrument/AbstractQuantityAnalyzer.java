...
public abstract class AbstractQuantityAnalyzer implements IQuantityAnalyzer {
	protected void finalizeQty(QuantityInstruction qi, SingleInstrumentStrategy strategy) {
		if(null == qi)
			return;
	...
	abstract protected QuantityInstruction calculate(SingleInstrumentStrategy strategy);
	
	@Override
	public QuantityInstruction analyze(SingleInstrumentStrategy strategy) {
