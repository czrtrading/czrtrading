...
public class OrderManager {
	...
	private AsyncEventProcessor eventProcessor = new AsyncEventProcessor() {
		...
		public void subscribeToEvents() {
			subscribeToEvent(ParentOrderSnapshotRequestEvent.class, null);
	...
	public void processParentOrderSnapshotRequestEvent(ParentOrderSnapshotRequestEvent event) throws Exception {
