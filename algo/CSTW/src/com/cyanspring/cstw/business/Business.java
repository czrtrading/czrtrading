...
import com.cyanspring.common.event.order.ParentOrderSnapshotRequestEvent;
...
//			log.info("Received message: " + message);
			if (event instanceof NodeInfoEvent ){
				...
				try {
					eventManager.sendRemoteEvent(new ParentOrderSnapshotRequestEvent(null, initClientEvent.getSender()));
	...
	synchronized private void processingSingleInstrumentStrategyFieldDefUpdateEvent(SingleInstrumentStrategyFieldDefUpdateEvent event) {
	...
	public void init() throws Exception {
		...
		eventManager.subscribe(SingleInstrumentStrategyFieldDefUpdateEvent.class, listener);		
