...
public class StrategyLogView extends ViewPart implements IAsyncEventListener {
	...
	private void processParentOrderSelectionEvent(ParentOrderSelectionEvent event) {
	...
	public void onEvent(AsyncEvent e) {
		...
		if (e instanceof ParentOrderSelectionEvent) {
			processParentOrderSelectionEvent((ParentOrderSelectionEvent)e);
